...
import {PinContainer} from "@/components/ui/card-pointer-hover";
                    ...
                    <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                        <li>
                            ...
                            <div className="timeline-start md:text-end mb-10">
                                ...
                                <div className="text-lg font-black justify-around">First Macintosh computer</div>
                        ...
                        <li>
                            ...
                            <div className="timeline-end lg:text-xl md:w-1/2 mb-10">
