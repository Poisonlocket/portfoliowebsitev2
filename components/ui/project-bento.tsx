...
const items = [
    {
        ...
        header: <div className={"w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-bl from-white via-blue-400 text-gray-900 to-blue-700 text-5xl text-center justify-center content-center font-bold"}>Bankgeheimnis</div>,
    ...
    },
    {
        ...
        header: <div className={"w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-bl from-gray-600 via-slate-750  to-slate-950 text-5xl text-gray-300 text-center justify-center content-center font-bold hover:text-white transition ease-in-out"}>Portfolio-V2</div>,
    ...
    },
    {
        ...
        header: <div className={"w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-bl from-gray-300 via-slate-600   to-black text-5xl text-center justify-center content-center font-bold"}>Portfolio-V1</div>,
    ...
    },
    {
        ...
        header:  <div className={"w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-bl from-rose-700 via-rose-950   to-black text-5xl text-center justify-center content-center font-bold"}><div className={"bg-gradient-to-l bg-clip-text text-transparent  from-rose-400 via-rose-800 to-rose-400"}>Swisshub - Bots</div></div>,
